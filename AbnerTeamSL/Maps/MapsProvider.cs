...
namespace AbnerTeamSL.Maps
{
	...
	{
		private static String URL_VECTOR_2000 = "http://t0.tianditu.com/vec_c/wmts";
		...
		private static String URL_IMAGE_2000 = "http://t0.tianditu.com/img_c/wmts";
		...
		private static String URL_TERRAIN_2000 = "http://t0.tianditu.com/ter_c/wmts";
		...
		private static String URL_IMAGE_2000_OFFLINE = MapHelper.GetUrl()+"Maps/TianDiTu_Img";
		private static String URL_IMAGE_ANNOTATION_CHINESE_2000_OFFLINE = MapHelper.GetUrl()+"Maps/TianDiTu_Img_Annotatoin";

		private static String LAYER_NAME_IMAGE_OFFLINE = ".jpg";
		private static String LAYER_NAME_IMAGE_ANNOTATION_CHINESE_OFFLINE = ".png";
		...
		public static TianDiTuLayerInfo getLayerInfo(int layerType)
		{
			...
			switch (layerType)
			{
				...
				case TianDiTuLayerTypes.TIANDITU_IMAGE_2000_OFFLINE:
					...
					layerInfo.setLayerName(LayerInfoFactory.LAYER_NAME_IMAGE_OFFLINE);
					break;
				case TianDiTuLayerTypes.TIANDITU_IMAGE_ANNOTATION_CHINESE_2000_OFFLINE:
					...
					layerInfo.setLayerName(LayerInfoFactory.LAYER_NAME_IMAGE_ANNOTATION_CHINESE_OFFLINE);
					break;
			}
